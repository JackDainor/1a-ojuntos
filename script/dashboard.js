...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${years} ${yearText}, ${months} ${monthText} y ${days} ${dayText}, desde que comenzó nuestra historia de amor. Me alegra mucho estar aún a tu lado y disfrutar cada momento. | Te amo y eres la única niña que amaré por toda mi vida. ¡Te Amooo❤️!`;
  }
});
...
const mensajes = [
    ...
    "Estaré a tu lado pase lo que pase. ☺️☺️",
"Te amo tal y como eres mi amor 🥰🥰❤️❤️",
